        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 text-accent mt-1">
              ...
              <span className="text-xs text-text-secondary ml-2 font-medium">{isEn ? "We trust our products 100%" : "نثق بمنتجاتنا 100%"}</span>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center p-20 space-y-4">
            ...
            <p className="text-text-secondary font-bold">{isEn ? "Loading order data..." : "جاري تحميل بيانات الطلب..."}</p>
          </div>
        }>
